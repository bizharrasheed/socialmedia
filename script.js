const countries = [
    ...
    { code: "44", name: "بەریتانیا", flag: "🇬🇧" },
    { code: "90", name: "تورکیا", flag: "🇹🇷" },
    { code: "98", name: "ئێران", flag: "🇮🇷" },
    { code: "963", name: "سوریا", flag: "🇸🇾" },
    { code: "966", name: "سعودیە", flag: "🇸🇦" },
    { code: "971", name: "ئیمارات", flag: "🇦🇪" },
    { code: "49", name: "ئەڵمانیا", flag: "🇩🇪" },
    { code: "33", name: "فەڕەنسا", flag: "🇫🇷" },
    { code: "46", name: "سوید", flag: "🇸🇪" },
    { code: "31", name: "هۆڵەندا", flag: "🇳🇱" },
...
const platformsData = {
    whatsapp: {
        ...
        desc: "ژمارێ بنڤیسە بێی سەیڤکرن، ڕاستەوخۆ دێ چات ڤەبیت.", placeholder: "750 000 0000", btnText: "ڤەکرنا چاتێ",
        colors: { main: "#25D366", dark: "#128C7E", light: "rgba(37, 211, 102, 0.15)", shadow: "rgba(37, 211, 102, 0.4)" },
    ...
    tiktok: {
        id: "tiktok", name: "تیکتۆک", type: "text", baseUrl: "https://www.tiktok.com/@",
        desc: "یوزەرنەیمی بنڤیسە بێی هێمایا @.", placeholder: "username", btnText: "ڤەکرنا تیکتۆکی",
        colors: { main: "#000000", dark: "#25F4EE", light: "rgba(0, 0, 0, 0.1)", shadow: "rgba(0, 0, 0, 0.4)" },
    ...
    viber: {
        id: "viber", name: "ڤایبەر", type: "phone", baseUrl: "viber://add?number=",
        desc: "ژمارێ بنڤیسە بۆ زێدەکرنا ڕاستەوخۆ ل سەر ڤایبەری.", placeholder: "750 000 0000", btnText: "زێدەکرنا ڤایبەری",
        colors: { main: "#7360f2", dark: "#5c4cd9", light: "rgba(115, 96, 242, 0.15)", shadow: "rgba(115, 96, 242, 0.4)" },
        svg: '<path d="M21.5 15.2c-.9-1.2-2.4-1.5-3.4-.4l-1.5 1.1c-1.5-1.2-4.1-3.7-5.1-5.1l1.1-1.5c1.1-1 .9-2.5-.4-3.4C10.8 4.6 9.6 3.5 8.3 2.5c-1.2-1-2.6-.7-3.4.4l-1.7 2C2.1 6 1.7 7.7 2 9.4c1 4.8 4.2 9.8 8.5 12.5 2.2 1.3 4.7 1.9 7.1 1.4 1.6-.3 3-1.3 3.9-2.6l2-1.7c1-1.1 1.2-2.6 0-3.8-1-1.3-2.1-2.5-2.2-2.5z"/>'
    },
    telegram: {
        id: "telegram", name: "تێلگرام", type: "text", baseUrl: "https://t.me/",
        desc: "یوزەرنەیمی بنڤیسە بۆ پەیوەندیێ (بۆ نموونە bizharrasheed).", placeholder: "username", btnText: "ڤەکرنا تێلگرامی",
        colors: { main: "#0088cc", dark: "#006699", light: "rgba(0, 136, 204, 0.15)", shadow: "rgba(0, 136, 204, 0.4)" },
        svg: '<path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.89 7.85l-1.95 9.17c-.15.65-.54.82-1.09.51l-3-2.21-1.45 1.4c-.16.16-.3.3-.61.3l.21-3.08 5.6-5.06c.25-.22-.05-.34-.38-.11l-6.93 4.36-2.98-.93c-.65-.2-.66-.65.14-.96l11.64-4.49c.54-.2 1.01.12.8.1z"/>'
    },
    facebook: {
        id: "facebook", name: "فەیسبووک", type: "text", baseUrl: "https://www.facebook.com/",
        desc: "یوزەرنەیم یان ئایدیێ پرۆفایلی بنڤیسە.", placeholder: "username", btnText: "ڤەکرنا پرۆفایلی",
        colors: { main: "#1877F2", dark: "#105cb8", light: "rgba(24, 119, 242, 0.15)", shadow: "rgba(24, 119, 242, 0.4)" },
    ...
    twitter: {
        id: "twitter", name: "X (تویتەر)", type: "text", baseUrl: "https://twitter.com/",
        desc: "یوزەرنەیمی بنڤیسە بۆ ڤەکرنا پرۆفایلی ل سەر X.", placeholder: "username", btnText: "ڤەکرنا هەژمارێ",
        colors: { main: "#1DA1F2", dark: "#0c85d0", light: "rgba(29, 161, 242, 0.15)", shadow: "rgba(29, 161, 242, 0.4)" },
    ...
    email: {
        id: "email", name: "ئیمێل", type: "email", baseUrl: "mailto:",
        desc: "ناونیشانێ ئیمێلی بنڤیسە بۆ ناردنا نامەیەکێ.", placeholder: "example@mail.com", btnText: "ناردنا ئیمێلی",
        colors: { main: "#EA4335", dark: "#c5221f", light: "rgba(234, 67, 53, 0.15)", shadow: "rgba(234, 67, 53, 0.4)" },
